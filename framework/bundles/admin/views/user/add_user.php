...
<div class="row">
    <div class="span7">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="user_name" placeholder="User Name of Villa" type="text" name="user_name" pattern="([a-zA-Z]\s*)+" required="required">
            </div>
        </div>
        <!--user dob-->
        <div class=" control-group">
            ...
            <div class="controls">
                <input id="dob" type="text" placeholder="YYYY/MM/DD" name="user_dob" />
            </div>
        </div>
      <!-- Gender -->
        <div class=control-group>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="user_mobile" placeholder="User Mobile" type="text" name="user_mobile" pattern="([0-9]*)" required="required">
            </div>
        </div>
        <!-- User Email_ID-->
        <div class="control-group">
            ...
            <div class="controls">
                    <input id="user_email" placeholder="User Email ID" type="text" name="user_email" required="required">
            </div>
        </div>
        <!-- User City--->
        <div class="control-group">
            ...
            <div class="controls">
                <input id="user_city" type="text" name="user_city" placeholder="User City" required="required"/>
            </div>
        </div>
        <!-- User Address---->
        <div class="control-group">
            ...
            <div class="controls">
                <input id="user_address" type="text" name="user_address" placeholder="User Address"/>
            </div>
        </div>
        <!-- User Organisation-->
        <div class="control-group">
            ...
            <div class="controls">
                <input id="user_organisation" type="text" name="user_organisation" placeholder="User Organisation" />
            </div>
        </div>
